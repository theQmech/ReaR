...
('b1','2 wheeler', 'btwin', 'White', 'company', 'lent',123,'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Triumph_Bicycle.JPG/440px-Triumph_Bicycle.JPG'),
('b2','2 wheeler', 'myBike', 'Black', 'company', 'lent',123,'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Triumph_Bicycle.JPG/440px-Triumph_Bicycle.JPG'),
('b3','2 wheeler', 'Hercules', 'Brown', 'company', 'lent',123,'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Triumph_Bicycle.JPG/440px-Triumph_Bicycle.JPG'),
('b4','2 wheeler', 'Hero', 'Black', 'company', 'lent',123,'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Triumph_Bicycle.JPG/440px-Triumph_Bicycle.JPG'),
('b5','2 wheeler', 'Firefox', 'Black', 'company', 'lent',123,'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Triumph_Bicycle.JPG/440px-Triumph_Bicycle.JPG'),
('b6','2 wheeler', 'Kross', 'Black', 'user', 'with_owner',123,'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Triumph_Bicycle.JPG/440px-Triumph_Bicycle.JPG');
...
insert into ownership values ('b6','u1');
