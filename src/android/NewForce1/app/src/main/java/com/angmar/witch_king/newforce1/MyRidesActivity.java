...
public class MyRidesActivity extends AppCompatActivity implements TabLayout.OnTabSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSectionsPagerAdapter = new MyRidesActivity.SectionsPagerAdapter(getSupportFragmentManager());
...
//    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    OwnedRidesActivity tab1 = new OwnedRidesActivity();
                    return tab1;
                case 1:
                    RentedRidesActivity tab2 = new RentedRidesActivity();
                    return tab2;
                default:
                    return null;
            }
